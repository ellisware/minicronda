# Original source: Miniconda install copy-pasted from Miniconda's own Dockerfile reachable at: 
...
RUN /opt/conda/bin/conda install pandas -y && \
    ...
    /opt/conda/bin/python3 -m pip install exchangelib html5lib bs4
...
# For reference
# Actual values are set at runtime
...
# Any ports required Bind Mount Volumes
